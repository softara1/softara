$(document).ready(function() {
    ...
    $('head').append(`<style>
        ...
        /* صف أزرار الإجراءات (تحميل، نسخ، مشاركة) */
    ...
    /* ========== النوافذ المنبثقة للأزرار الرئيسية ========== */
    ...
    // نافذة المشاركة المنبثقة (تُستخدم لاحقاً)
    ...
    function parseBBCodes() {
        $('.content,.postbody .content,.post-content,.post-body').each(function() {
            ...
            // تحويل [video width=... height=...]...[/video]
